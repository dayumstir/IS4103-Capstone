...
class Customer(db.Model):
    ...
    credit_score_history = db.Column(db.String, nullable=True) # Credit score history
    credit_utilisation_ratio = db.Column(db.Float, nullable=True) # Credit utilisation ratio
