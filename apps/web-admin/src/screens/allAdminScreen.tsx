...
import { useViewAllAdminQuery, useUpdateStatusMutation } from "../redux/services/adminService";
...
const { Title, Text } = Typography;
  ...
  const handleUpdateAdmin = async (
    ...
    try {
      await updateAdminStatus({ updatedAdminId: editingAdmin.admin_id, admin_type: admin_type1.toString() }).unwrap();

      setIsModalOpen(false);
      setEditingAdmin(null);
      message.success(
        `Admin "${editingAdmin.name}" has been updated.`,
      );
    } catch (error) {
